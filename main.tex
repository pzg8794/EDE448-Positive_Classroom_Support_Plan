...
\rowcolor{SoftGray}
Teach &
Model the difference among a thought, feeling, fact, need, action, outcome, and identity. Use ordinary academic errors to teach that an unsuccessful attempt is information, not a moral judgment. Teach learners to connect evidence to feedback, support, and a next move. &
Students may create, select, type, point to, speak, sign, or internally use a phrase. They may reject an adult's wording, identify what an attempt taught them, and propose language that fits their experience. \\
Reinforce &
