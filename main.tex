...
\end{tikzpicture}
\caption{An original five-step cycle for evidence-based positive self-talk. The EQUITAS audit remains active across.}
...
% \small
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.70in} >{\RaggedRight\arraybackslash}p{2.25in} >{\RaggedRight\arraybackslash}p{2.05in} >{\RaggedRight\arraybackslash}p{1.74in}}
\rowcolor{PrimaryRed}
