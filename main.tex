...
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.52\textwidth]{assets/identity-beads-evidence-still-life.png}
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.8in} >{\RaggedRight\arraybackslash}p{3.35in} >{\RaggedRight\arraybackslash}p{2.85in}}
